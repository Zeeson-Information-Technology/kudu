...
export const aboutTeam = {
  title: "Our Team",
  intro: "A passionate group of engineers, healthcare experts, and entrepreneurs committed to transforming primary care.",
  members: [
    {
      name: "Ibrahim Saliman",
      role: "Senior Software Engineer and B2G Expert",
    ...
    {
      name: "Tope Odutade",
      role: "Health Operations and Sales",
...
export const aboutCta = {
  ...
  description: "Whether you're a health facility, state authority, or development partner, we welcome collaboration to strengthen Nigeria's primary healthcare system.",
